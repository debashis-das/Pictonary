...
class Round(object):
    ...
    def skip(self):
        """
        returns true if round skipped thresold met
        :return: bool
        """
        self.skips += 1
    ...
    def time_thread(self):
        """
        Runs in thread to keep  thrack of time
        :return: None
        """
        while self.time > 0:
            t.sleep(1)
    ...
    def guess(self, player, wrd):
        """
        :returns bool if player got a guess correct 
        :param player: Player
        :param wrd: str
        :return: bool
        """
    ...
    def player_left(self, player):
        ...
        :return: None
        """
        #might not be able to use player as a key in dict
        if player in self.player_scores:
    ...
    def end_round(self,msg):
        # TODO implement end_round functionallity here 
        pass    
